...
function Post(props) {
      ...
      const [likes, setLikes] = new useState([]);
      const [openLikes, setOpenLikes] = new useState(false);
            ...
            if(props.postId){
                  ...
                  .onSnapshot((snapshot) => {
                        setLikes(snapshot.docs.map((doc) => {
                              if(doc.data().by === props.currentUser){
                                    setIsLiked(true);
                              }
